...
class TestMutiContract(ParametrizedTestCase):
    def setUp(self):
        time.sleep(2)
        DEFAULT_NODE_ARGS = "--ws --rest --loglevel=0 --clirpc --networkid=388"
        print("stop all")
        stop_node(0)
        stop_node(1)
        stop_node(2)
    ...
    def test_04(self):
        ...
        try:
            ...
            (result, response) = bind_user_role(contract_address,Common.ontID_A, Common.roleB_hex, [Common.ontID_A])
            if not result:
                raise("bind_user_role error")
            # setp 3 用户A访问A函数
            (result, response) = invoke_function(contract_address, "B", Common.ontID_A)
    ...
    def test_05(self):
        ...
        try:
            ...
            (result, response) = delegate_user_role(contract_address, Common.ontID_B, Common.ontID_A, Common.roleB_hex, "100", "1")
            if not result:
                raise("bind_user_role error")
    ...
    def test_18(self):
        ...
        try:
			...
			# setp 2 用户A授权用户B拥有roleA角色
            (result, response) = delegate_user_role(contract_address, Common.ontID_A, Common.ontID_B, Common.roleA_hex, "5", "1")
            if not result:
                raise("bind_user_role error")
    ...
    def test_21(self):
        ...
        try:
            ...
            # setp 3 用户A授权用户B拥有roleA角色
            (result, response) = delegate_user_role(contract_address, Common.ontID_A, Common.ontID_B, Common.roleA_hex, "100", "1")
            if not result:
                raise("bind_user_role error")
    ...
    def test_27(self):
        ...
        try:
            ...
            (result, response) = delegate_user_role(contract_address, Common.ontID_B, Common.ontID_C, Common.roleA_hex, "100", "1")
            if not result:
                raise("bind_user_role error")
    ...
    def test_29(self):
        ...
        try:
            ...
            # setp 1 用户B授权用户B拥有roleA角色
            (result, response) = delegate_user_role(contract_address, Common.ontID_B, Common.ontID_C, Common.roleA_hex, "10", "1")
            if not result:
                raise("bind_user_role error")
    ...
    def test_36(self):
        ...
        try:
			...
			# setp 1 用户A授权用户B拥有角色A的权限
            (result, response) = delegate_user_role(contract_address_B, Common.ontID_A, Common.ontID_B, Common.roleA_hex, "5", "1")
            if not result:
                raise("bind_user_role error")
    ...
    def test_44(self):
        ...
        try:
            ...
            # 用户B调用智能合约A中的A方法
            (result, response) = invoke_function(contract_addressA, "A", Common.ontID_B)
            if not result:
                raise Error("invoke_function error")
    ...
    def test_48(self):
        ...
        try:
            ...
            (result, response) = delegate_user_role(contract_address, Common.ontID_A, Common.ontID_B, Common.roleA_hex, "1000", "1")
            if not result:
                raise("bind_user_role error")
    ...
    def test_56(self):
        ...
        try:
            ...
            (result, response) = invoke_function(contract_address, "approve_ong", Common.ontID_B, argvs = [ {
																					"type": "bytearray",
																					"value": script_hash_bl_reserver(base58_to_address(Config.SERVICES[Common.node_A]["address"]))
																				},
																				{
    ...
    def test_57(self):
        ...
        try:
            ...
            (result, response) = invoke_function(contract_address, "approve_ong", Common.ontID_A, argvs = [ {
																					"type": "bytearray",
																					"value": script_hash_bl_reserver(base58_to_address(Config.SERVICES[Common.node_A]["address"]))
																				},
																				{
            ...
            (result, response) = invoke_function(contract_address, "transferFrom_ong", Common.ontID_B, argvs = [ {
																					"type": "bytearray",
																					"value": script_hash_bl_reserver(base58_to_address(Config.SERVICES[Common.node_B]["address"]))
																				},
																				{
    ...
    def test_59(self):
        ...
        try:
            ...
            # 用户B调用智能合约A中的A方法查询用户A给用户C的ont还有多少没有接收
            (result, response) = invoke_function(contract_address, "allowance_ong", Common.ontID_B, argvs = [ {
																					"type": "bytearray",
																					"value": script_hash_bl_reserver(base58_to_address(Config.SERVICES[Common.node_A]["address"]))
																				},
																				{
