...
sender4_node=2
sender4Type=False
sender5= deploy_contract("ontErr.json")  #sender_错误的sender值（未被授权的智能合约地址)_异常
sender5_node=2
sender5Type=True
...
class TestContract(ParametrizedTestCase):
	...
	def test_023_transferFrom(self):
		...
		time.sleep(15)
		(result, response) = transferFrom(contract_address,sender1,pay_address,get_address, amount,2,sender1Type,errorcode=0)
		logger.close(result)
	def test_024_transferFrom(self):
		logger.open( "24_transferFrom.log","24_transferFrom")
		(result, response) = approve1(contract_address,pay_address,contract_address, amount,node_index,0)#先approve
		time.sleep(15)
		(result, response) = transferFrom(contract_address,sender2,pay_address,contract_address, amount,sender2_node,sender2Type,errorcode=0)
		logger.close(result)
	...
	def test_025_transferFrom(self):
		...
		(result, response) = approve1(contract_address,pay_address,get_address, amount,node_index,0)#先approve
		time.sleep(15)
		(result, response) = transferFrom(contract_address,sender3,pay_address,get_address, amount,sender3_node,sender3Type)
		logger.close(result)
	...
	def test_039_transferFrom(self):
		...
		(result, response) = approve1(contract_address,pay_address,get_address, "1",node_index,0)
	...
	def test_080_transferFrom(self):
		...
		(result, response) = approve1(contract_address,pay_address,contract_address, amount,node_index,0)
		time.sleep(15)
		(result, response) = transferFrom1(contract_address,sender3,pay_address,contract_address, amount,sender3_node,sender3Type)
		logger.close(result)
